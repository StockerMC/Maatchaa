...
export default function CreatorsPage() {
    ...
    return (
        <div className="relative min-h-screen w-full overflow-hidden bg-white/10 rounded-2xl ml-20 mr-20">
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8">
                <div className="max-w-4xl w-full mx-auto text-center bg-white/5 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12">
                ...
                <div className="w-full max-w-5xl mx-auto mt-16 px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                        <div className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl shadow-lg">
